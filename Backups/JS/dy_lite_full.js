...
#签到（有问题
/luckycat/aweme/v1/task/sign_in/* url script-request-header dy_lite_full.js

#步数
/luckycat/aweme/v1/task/walk/step_submit? url script-request-header dy_lite_full.js

#红包进度条，首页宝箱，宝箱广告，直播宝箱
luckycat/aweme/v1/task/done/(read|excitation_ad|treasure_task|excitation_ad_treasure_box|live_treasure)? url script-request-header dy_lite_full.js
*/
